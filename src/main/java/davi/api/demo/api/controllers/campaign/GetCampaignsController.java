...
public class GetCampaignsController {

    private final GetAllCampaignsUseCase getAllCampaignsUseCase;

    @Autowired
    public GetCampaignsController(CreateCampaignUseCase createCampaignUseCase,
                              GetAllCampaignsUseCase getAllCampaignsUseCase) {
        this.getAllCampaignsUseCase = getAllCampaignsUseCase;
    }

    @GetMapping
    public ResponseEntity<GetAllCampaignsResponse> handle() {
